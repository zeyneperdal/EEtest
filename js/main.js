...
;(function(window) {
	...
	Day.prototype._layout = function() {
		...
		*/
		...
		this.cube.innerHTML = '<div class="cube__side cube__side--back"></div><div class="cube__side cube__side--left"></div><div class="cube__side cube__side--right"></div><div class="cube__side cube__side--bottom"></div><div class="cube__side cube__side--top"></div><div class="cube__side cube__side--front">' + (this.number+1) + '</div></div>';
	...
	function Calendar(el) {
		...
		this.dayPreview.className = 'ttitle';
